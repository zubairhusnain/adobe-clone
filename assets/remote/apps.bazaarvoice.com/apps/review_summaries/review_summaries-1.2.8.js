...
`,de=class de extends S{render(){return p`
      <svg
        width="30"
        height="30"
        viewBox="0 0 15 15"
  ...
  `;let he=de;customElements.define("swat-hosted-loading-icon",he);class Ki{constructor(t,s={}){this.isActive=!1,this.lastFocusedElement=null,this.focusableElements=[],this.handleKeyDown=i=>{if(this.isActive)switch(i.key){case"Escape":this.options.onEscape&&(i.preventDefault(),this.options.onEscape());break;case"Tab":this.handleTabKey(i);break}},this.handleFocusIn=i=>{if(!this.isActive)return;const o=i.target;this.isElementInContainer(o)||(i.preventDefault(),this.focusableElements.length>0&&this.focusableElements[0].focus())},this.container=t,this.options=Object.assign({includeShadowDOM:!0},s)}activate(){if(this.isActive)return;this.isActive=!0,this.lastFocusedElement=document.activeElement,this.updateFocusableElements(),this.addEventListeners();const t=this.options.initialFocusElement||this.focusableElements[0];t&&t.focus()}deactivate(){if(!this.isActive)return;this.isActive=!1,this.removeEventListeners();const t=this.options.returnFocusElement||this.lastFocusedElement;t&&typeof t.focus=="function"&&t.focus()}updateFocusableElements(){this.focusableElements=this.getFocusableElements(this.container)}getFocusableElements(t){const s=["button:not([disabled])","input:not([disabled])","select:not([disabled])","textarea:not([disabled])","a[href]",'[tabindex]:not([tabindex="-1"])',"label[for]",'[contenteditable="true"]'],i=[];return s.forEach(c=>{const h=Array.from(t.querySelectorAll(c));i.push(...h.filter(l=>this.isVisible(l)))}),t.querySelectorAll("slot").forEach(c=>{c.assignedElements().forEach(l=>{s.forEach(u=>{l.matches(u)&&this.isVisible(l)&&i.push(l)}),s.forEach(u=>{const d=Array.from(l.querySelectorAll(u));i.push(...d.filter(b=>this.isVisible(b)))}),l.shadowRoot&&i.push(...this.getFocusableElements(l.shadowRoot))})}),this.options.includeShadowDOM&&t.querySelectorAll("*").forEach(h=>{h.shadowRoot&&i.push(...this.getFocusableElements(h.shadowRoot))}),Array.from(new Set(i)).filter(c=>c.tabIndex!==-1).sort((c,h)=>{const l=c.compareDocumentPosition(h);if(l&Node.DOCUMENT_POSITION_FOLLOWING)return-1;if(l&Node.DOCUMENT_POSITION_PRECEDING)return 1;let u=c,d=h;for(;u.parentElement;)u=u.parentElement;for(;d.parentElement;)d=d.parentElement;if(u.parentNode&&"host"in u.parentNode&&(u=u.parentNode.host),d.parentNode&&"host"in d.parentNode&&(d=d.parentNode.host),u!==d){const b=u.compareDocumentPosition(d);if(b&Node.DOCUMENT_POSITION_FOLLOWING)return-1;if(b&Node.DOCUMENT_POSITION_PRECEDING)return 1}return 0})}isVisible(t){const s=window.getComputedStyle(t);return s.display!=="none"&&s.visibility!=="hidden"&&t.offsetWidth>0&&t.offsetHeight>0}addEventListeners(){document.addEventListener("keydown",this.handleKeyDown),document.addEventListener("focusin",this.handleFocusIn)}removeEventListeners(){document.removeEventListener("keydown",this.handleKeyDown),document.removeEventListener("focusin",this.handleFocusIn)}handleTabKey(t){if(t.preventDefault(),this.updateFocusableElements(),this.focusableElements.length===0)return;if(this.focusableElements.length===1){this.focusableElements[0].focus();return}const s=this.getActuallyFocusedElement();let i=this.focusableElements.indexOf(s);i===-1&&(i=t.shiftKey?this.focusableElements.length:-1);let o;t.shiftKey?o=i<=0?this.focusableElements.length-1:i-1:o=i>=this.focusableElements.length-1?0:i+1;const r=this.focusableElements[o];r&&(r.focus(),setTimeout(()=>{var n;this.getActuallyFocusedElement()!==r&&((n=this.focusableElements[0])===null||n===void 0||n.focus())},10))}getActuallyFocusedElement(){let t=document.activeElement;for(;t&&t.shadowRoot&&t.shadowRoot.activeElement;)t=t.shadowRoot.activeElement;return t}isElementInContainer(t){var s;if(this.container.contains(t)||this.focusableElements.includes(t))return!0;let i=t;for(;i;){if(i===this.container)return!0;if(i.parentNode)i=i.parentNode;else if(i instanceof ShadowRoot)i=i.host;else break}const o=(s=this.container.shadowRoot)===null||s===void 0?void 0:s.querySelectorAll("slot");if(o)for(const r of o){const n=r.assignedElements();for(const a of n)if(a===t||a.contains(t))return!0}return!1}updateOptions(t){this.options=Object.assign(Object.assign({},this.options),t)}isActivated(){return this.isActive}getFocusableElementsList(){return[...this.focusableElements]}}var X=function(e,t,s,i){var o=arguments.length,r=o<3?t:i===null?i=Object.getOwnPropertyDescriptor(t,s):i,n;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")r=Reflect.decorate(e,t,s,i);else for(var a=e.length-1;a>=0;a--)(n=e[a])&&(r=(o<3?n(r):o>3?n(t,s,r):n(t,s))||r);return o>3&&r&&Object.defineProperty(t,s,r),r};let F=class extends S{constructor(){super(),this.open=!1,this.title="",this.closeButtonAriaLabel="",this.OnClose=()=>{this.open=!this.open},this.modalLoaded=()=>{},this.defaultClose=()=>{this.open=!1,this.OnClose()},this.styleConfig={closeButton:{size:""},minHeight:"150px"},this.errorType=!1,this.focusManager=null,this.previouslyFocusedElement=null,this.originalBodyOverflow=""}static generateStyles(){return T`
    ...
    `}};X([m({type:Boolean})],F.prototype,"open",void 0),X([m({type:String})],F.prototype,"title",void 0),X([m({type:String})],F.prototype,"closeButtonAriaLabel",void 0),X([m({type:Function})],F.prototype,"OnClose",void 0),X([m({type:Function})],F.prototype,"modalLoaded",void 0),X([m({type:Object})],F.prototype,"styleConfig",void 0),X([m({type:Boolean})],F.prototype,"errorType",void 0),F=X([B("modal-component")],F);var R=function(e,t,s,i){var o=arguments.length,r=o<3?t:i===null?i=Object.getOwnPropertyDescriptor(t,s):i,n;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")r=Reflect.decorate(e,t,s,i);else for(var a=e.length-1;a>=0;a--)(n=e[a])&&(r=(o<3?n(r):o>3?n(t,s,r):n(t,s))||r);return o>3&&r&&Object.defineProperty(t,s,r),r},Qi=function(e,t,s,i){function o(r){return r instanceof s?r:new s(function(n){n(r)})}return new(s||(s=Promise))(function(r,n){function a(l){try{h(i.next(l))}catch(u){n(u)}}function c(l){try{h(i.throw(l))}catch(u){n(u)}}function h(l){l.done?r(l.value):o(l.value).then(a,c)}h((i=i.apply(e,t||[])).next())})};let P=class extends S{constructor(){super(...arguments),this.messages={},this.onSubmit=()=>{},this.onFieldChange=()=>{},this.onReasonClick=()=>{},this.formData={},this.isSubmitting=!1,this.validationErrors=new Map,this.showValidation=!1}connectedCallback(){super.connectedCallback(),this.initializeFormData()}initializeFormData(){var t;this.formData={},(t=this.config)===null||t===void 0||t.fields.forEach(s=>{if(s.defaultValue!==void 0)this.formData[s.id]=s.defaultValue;else switch(s.type){case"checkbox-group":case"multi-select":case"radio":this.formData[s.id]=[];break;default:this.formData[s.id]=""}})}render(){return p`
  ...
  `,R([m({type:Object})],P.prototype,"config",void 0),R([m({type:Object})],P.prototype,"messages",void 0),R([m({type:Function})],P.prototype,"onSubmit",void 0),R([m({type:Function})],P.prototype,"onFieldChange",void 0),R([m({type:Function})],P.prototype,"onReasonClick",void 0),R([E()],P.prototype,"formData",void 0),R([E()],P.prototype,"isSubmitting",void 0),R([E()],P.prototype,"validationErrors",void 0),R([E()],P.prototype,"showValidation",void 0),P=R([B("bv-submission-form")],P);var to=Object.defineProperty,eo=Object.getOwnPropertyDescriptor,it=(e,t,s,i)=>{for(var o=i>1?void 0:i?eo(t,s):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(o=(i?n(t,s,o):n(o))||o);return i&&o&&to(t,s,o),o};let U=class extends S{constructor(){super(...arguments),this.voteType="upvote",this.onSubmit=()=>{},this.onCancel=()=>{},this.onReasonClick=()=>{},this.isOthersSelected=!1}get submissionFormConfig(){var e;return{title:this.config.title,subtitle:this.config.subtitle,submitButtonText:this.config.submitButtonText,fields:[{id:"feedbackReason",type:"checkbox-group",label:this.config.reasonLabel,mandatory:!0,validationMessage:this.config.validationErrorMessage,options:this.config.predefinedReasons.map(t=>({id:t.id,label:t.text,value:t.id}))},{id:"feedbackText",type:"textarea",label:this.config.commentLabel,placeholder:this.config.commentPlaceholder,mandatory:this.isOthersSelected,rows:4,maxLength:250,ariaLabel:this.config.commentAriaLabel,validationMessage:((e=this.config.messages)==null?void 0:e.feedbackText_validation_error)||""}]}}render(){return p`
      ...
      ></bv-submission-form>
    `}handleFieldChange(e,t){var s;if(e==="feedbackReason"&&Array.isArray(t)){const i=this.isOthersSelected;if(this.isOthersSelected=t.includes("other"),i!==this.isOthersSelected){if(i&&!this.isOthersSelected){const o=(s=this.shadowRoot)==null?void 0:s.querySelector("bv-submission-form");o&&o.clearFieldValidation("feedbackText")}this.requestUpdate()}}}async handleFormSubmit(e){var o;const t=e.feedbackReason,s=((o=e.feedbackText)==null?void 0:o.trim())||"",i={vote:this.voteType,feedbackReason:t,feedbackText:s};await this.onSubmit(i)}reset(){var t;this.isOthersSelected=!1;const e=(t=this.shadowRoot)==null?void 0:t.querySelector("bv-submission-form");e&&e.reset()}};U.styles=T`
    :host {
      display: block;
    }
  `,it([m({type:Object})],U.prototype,"config",2),it([m({type:String})],U.prototype,"voteType",2),it([m({type:Function})],U.prototype,"onSubmit",2),it([m({type:Function})],U.prototype,"onCancel",2),it([m({type:Function})],U.prototype,"onReasonClick",2),it([E()],U.prototype,"isOthersSelected",2),U=it([B("review-summaries-feedback-form")],U);var St=function(e,t,s,i){var o=arguments.length,r=o<3?t:i===null?i=Object.getOwnPropertyDescriptor(t,s):i,n;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")r=Reflect.decorate(e,t,s,i);else for(var a=e.length-1;a>=0;a--)(n=e[a])&&(r=(o<3?n(r):o>3?n(t,s,r):n(t,s))||r);return o>3&&r&&Object.defineProperty(t,s,r),r};let Z=class extends S{constructor(){super(),this.ariaLabel="",this.onLoadFocus=!1,this.OnClick=()=>{},this.props={title:"Close",size:"",width:0,height:0,type:"",id:"",color:""},this.attachShadow({mode:"open"}),this.ariaLabel="",this.OnClick=()=>{},this.props={title:"Close",size:"",width:0,height:0,type:"",id:"",color:""}}firstUpdated(){var t,s;this.onLoadFocus&&((s=(t=this.shadowRoot)===null||t===void 0?void 0:t.querySelector("button"))===null||s===void 0||s.focus())}render(){const t=p`
      <svg
    ...
    `}};Z.properties={ariaLabel:{type:String,state:!0},OnClick:{type:Function,state:!0},props:{type:Object,state:!0}},Z.styles=T`
    button {
      box-sizing: border-box;
      padding: 5px 5px;
      margin-right: 10px;
  ...
  `,St([m({type:String})],Z.prototype,"ariaLabel",void 0),St([m({type:Boolean})],Z.prototype,"onLoadFocus",void 0),St([m({type:Function})],Z.prototype,"OnClick",void 0),St([m({type:Object})],Z.prototype,"props",void 0),Z=St([B("bv-close-button")],Z);const so=p`
  <svg
    aria-hidden="true"
    width="18px"
    height="18px"
...
`;var ht=function(e,t,s,i){var o=arguments.length,r=o<3?t:i===null?i=Object.getOwnPropertyDescriptor(t,s):i,n;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")r=Reflect.decorate(e,t,s,i);else for(var a=e.length-1;a>=0;a--)(n=e[a])&&(r=(o<3?n(r):o>3?n(t,s,r):n(t,s))||r);return o>3&&r&&Object.defineProperty(t,s,r),r};let W=class extends S{constructor(){super(...arguments),this.showFeedback=!0,this.configuration={},this.callbacks=()=>null,this._votedUpvote=!1,this._votedDownvote=!1}render(){var t,s,i;return this.showFeedback?p`
    ...
    `:p``}_onUpvote(){!this._votedUpvote&&!this._votedDownvote&&(this._votedUpvote=!0,this.callbacks("upvote"))}_onDownvote(){!this._votedUpvote&&!this._votedDownvote&&(this._votedDownvote=!0,this.callbacks("downvote"))}};W.styles=T`
...
`;var ao=Object.defineProperty,lo=Object.getOwnPropertyDescriptor,$=(e,t,s,i)=>{for(var o=i>1?void 0:i?lo(t,s):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(o=(i?n(t,s,o):n(o))||o);return i&&o&&ao(t,s,o),o};let C=class extends S{constructor(){super(...arguments),this.summaryText="",this.showFeedback=!0,this._votedUpvote=!1,this._votedDownvote=!1,this.showModal=!1,this.currentVoteType="upvote",this.feedbackDisabled=!1,this.submissionState="form"}get closeButtonAriaLabel(){var e,t,s;return this.submissionState==="success"?`${((e=this.localization)==null?void 0:e.formatMessage("inpage_arialabel_success_popup_close_button"))||""}`:this.submissionState==="error"?`${((t=this.localization)==null?void 0:t.formatMessage("close_error_modal_label"))||""}`:((s=this.localization)==null?void 0:s.formatMessage("close_feedback_form_label"))||""}connectedCallback(){super.connectedCallback(),this.initializeSessionManager()}initializeSessionManager(){var e;if((e=this.config)!=null&&e.productId&&!this.sessionManager&&(this.sessionManager=new oo(`review_summary_feedback_${this.config.productId}`),this.feedbackDisabled=this.sessionManager.hasSubmittedFeedback(),this.feedbackDisabled)){const t=this.sessionManager.getSubmittedFeedback();t&&(t.vote==="upvote"?this._votedUpvote=!0:t.vote==="downvote"&&(this._votedDownvote=!0))}}shouldUpdate(e){return this.localization=new q(this.config),e.has("config")&&(this.localization=new q(this.config),this.initializeSessionManager()),!0}render(){var t,s,i;if(!this.showFeedback)return p``;const e=this.feedbackDisabled||this._votedUpvote||this._votedDownvote;return p`
  ...
  `,$([N({context:_t}),m({attribute:!1})],C.prototype,"analytics",2),$([N({context:Et}),m({attribute:!1})],C.prototype,"localization",2),$([N({context:cs}),m({attribute:!1})],C.prototype,"api",2),$([m({type:String})],C.prototype,"summaryText",2),$([m({type:Boolean})],C.prototype,"showFeedback",2),$([m({attribute:!1})],C.prototype,"config",2),$([E()],C.prototype,"_votedUpvote",2),$([E()],C.prototype,"_votedDownvote",2),$([E()],C.prototype,"showModal",2),$([E()],C.prototype,"currentVoteType",2),$([E()],C.prototype,"feedbackDisabled",2),$([E()],C.prototype,"submissionState",2),$([E()],C.prototype,"triggeringButtonRef",2),C=$([B("swat-feedback-button")],C);var ho=Object.defineProperty,co=Object.getOwnPropertyDescriptor,uo=(e,t,s,i)=>{for(var o=i>1?void 0:i?co(t,s):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(o=(i?n(t,s,o):n(o))||o);return i&&o&&ho(t,s,o),o};const fo=T`
...
* `).map((z,Nt)=>Nt===0?z.substring(2):z):[],t=((c=(a=this.config)==null?void 0:a.features.reviewSummaryConfigs)==null?void 0:c.summaryFormatType)===wt?e.length>2:this._summary.length>200;let s;this._showFullText||((h=this.config)==null?void 0:h.type)==="modal"?s=((u=(l=this.config)==null?void 0:l.features.reviewSummaryConfigs)==null?void 0:u.summaryFormatType)===wt?e:this._summary:s=((b=(d=this.config)==null?void 0:d.features.reviewSummaryConfigs)==null?void 0:b.summaryFormatType)===wt?e.slice(0,2):this._summary.length>200?this._summary.slice(0,200)+"...":this._summary;const i=`
  ...
  `,H([m({attribute:!1,type:Object})],M.prototype,"config",2),H([Lt({context:Yi})],M.prototype,"appConfig",2),H([N({context:_t}),m({attribute:!1})],M.prototype,"analytics",2),H([Lt({context:cs})],M.prototype,"api",2),H([N({context:Et}),m({attribute:!1})],M.prototype,"localization",2),H([E()],M.prototype,"_showFullText",2),H([E()],M.prototype,"_summary",2),H([E()],M.prototype,"_errorMessage",2),H([E()],M.prototype,"_loading",2),M=H([B("swat-review-summaries")],M);var vo=Object.defineProperty,go=Object.getOwnPropertyDescriptor,yo=(e,t,s,i)=>{for(var o=i>1?void 0:i?go(t,s):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(o=(i?n(t,s,o):n(o))||o);return i&&o&&vo(t,s,o),o};let ue=class extends S{render(){return p`
      <svg
        width="12px"
        height="12px"
        viewBox="0 0 27 27"
  ...
  `,ue=yo([B("swat-hosted-close-icon")],ue);function us(e,t){const s=i=>{i.key==="Tab"&&(i.preventDefault(),t==null||t.focus())};e.addEventListener("keydown",s)}var xo=Object.defineProperty,wo=Object.getOwnPropertyDescriptor,It=(e,t,s,i)=>{for(var o=i>1?void 0:i?wo(t,s):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(o=(i?n(t,s,o):n(o))||o);return i&&o&&xo(t,s,o),o};let ct=class extends S{firstUpdated(){this.updateTooltipPosition(),window.addEventListener("resize",this.updateTooltipPosition.bind(this)),window.addEventListener("scroll",this.updateTooltipPosition.bind(this))}shouldUpdate(e){return this.localization=new q(this.config),e.has("config")?(this.localization=new q(this.config),!0):!1}updated(e){var t,s;if(e.has("config")){this.updateTooltipPosition(),this.style.display="block";const i=(t=this.shadowRoot)==null?void 0:t.querySelector(".swat-hosted-close-btn"),o=(s=this.shadowRoot)==null?void 0:s.querySelector("#swat-hosted-tooltip-content");i&&(i.focus(),us(i,o))}}updateTooltipPosition(){var r,n;const e=(r=this.config)==null?void 0:r.inlineApp,t=e==null?void 0:e.getBoundingClientRect(),s=t?t.top-320:100,i=t?t.left+t.width/2-175:0,o=(n=this.shadowRoot)==null?void 0:n.querySelector(".swat-hosted-tooltip");o&&(o.style.top=`${s}px`,o.style.left=`${i}px`)}render(){var e;return p`
      <div class="swat-hosted-tooltip">
        <slot></slot>
       <button class="swat-hosted-close-btn" aria-label=${(e=this.localization)==null?void 0:e.formatMessage("close_ai_review_summary")} @click="${t=>this.closeSummary(t)}" >
          <swat-hosted-close-icon></swat-hosted-close-icon>
        </button>
        <div class="swat-hosted-tooltip-content" id="swat-hosted-tooltip-content" tabindex="0" @keydown="${t=>this.handleKeyDown(t)}">
          <slot name="swat-hosted-tooltip-content-slot"></slot>
        </div>
      </div>
    `}closeSummary(e){var s,i;e==null||e.stopPropagation(),(s=this.analytics)==null||s.trackModalClose(),this.style.display="none";const t=(i=this.config)==null?void 0:i.inlineApp;if(t){const o=t.querySelector("button");o?o.focus():console.warn("No button found within the trigger element")}}handleKeyDown(e){var t;if(e.key==="Tab"){e.preventDefault();const s=(t=this.shadowRoot)==null?void 0:t.querySelector(".swat-hosted-close-btn");s&&s.focus()}}};ct.styles=T`
    :host {
      display: block;
      position: relative;
    }
  ...
  `,It([N({context:_t}),m({attribute:!1})],ct.prototype,"analytics",2),It([N({context:Et}),m({attribute:!1})],ct.prototype,"localization",2),It([m({attribute:!1})],ct.prototype,"config",2),ct=It([B("swat-hosted-tooltip-component")],ct);var _o=Object.defineProperty,Eo=Object.getOwnPropertyDescriptor,Ot=(e,t,s,i)=>{for(var o=i>1?void 0:i?Eo(t,s):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(o=(i?n(t,s,o):n(o))||o);return i&&o&&_o(t,s,o),o};let ut=class extends S{updated(e){var t;if(e.has("config")){this.style.display="block",document.body.style.overflow="hidden";const s=(t=this.shadowRoot)==null?void 0:t.querySelector(".swat-hosted-mobile-card-close-btn");s&&(s.focus(),us(s))}}shouldUpdate(e){return this.localization=new q(this.config),e.has("config")?(this.localization=new q(this.config),!0):!1}render(){var e;return p`
    ...
    `}closeSummary(){var t,s;this.style.display="none",document.body.style.overflow="auto",(t=this.analytics)==null||t.trackModalClose();const e=(s=this.config)==null?void 0:s.inlineApp;if(e){const i=e.querySelector("button");i?i.focus():console.warn("No button found within the trigger element")}}};ut.styles=T`
