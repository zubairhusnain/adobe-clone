...
<!DOCTYPE html><html lang="en-US" dir="ltr" data-escape-initialized="true"><head>
    <title>Convert PDF to Word for free - PDF to DOCX Converter</title>
    <link rel="canonical" href="/acrobat/online/pdf-to-word/">
    <meta name="description" content="Learn how to convert PDF to Word using our online tool. Get started with our free PDF to Word converter to convert PDF to DOCX and more.">
    <meta property="og:title" content="Convert PDF to Word for free - PDF to DOCX Converter">
    <meta property="og:description" content="Learn how to convert PDF to Word using our online tool. Get started with our free PDF to Word converter to convert PDF to DOCX and more.">
    <meta property="og:image" content="acrobat/online/media_1072dc767a3b9645e80c278d17d37351abb12b7f2.png?width=1200&amp;format=pjpg&amp;optimize=medium">
    <meta property="og:image:secure_url" content="acrobat/online/media_1072dc767a3b9645e80c278d17d37351abb12b7f2.png?width=1200&amp;format=pjpg&amp;optimize=medium">
    <meta property="og:image:alt" content="https://www.adobe.com/dc-shared/fragments/modals/videos/frictionless/how-to-convert-pdf-to-word#video%20|%20Play%20video:%20How%20to%20convert%20PDF%20to%20Word%20|%20:play-medium" data-localized="true">
    <meta name="twitter:card" content="summary_large_image">
    <meta name="twitter:title" content="Convert PDF to Word for free - PDF to DOCX Converter">
    <meta name="twitter:description" content="Learn how to convert PDF to Word using our online tool. Get started with our free PDF to Word converter to convert PDF to DOCX and more.">
    <meta name="twitter:image" content="acrobat/online/media_1072dc767a3b9645e80c278d17d37351abb12b7f2.png?width=1200&amp;format=pjpg&amp;optimize=medium">
    <meta name="target" content="on">
    <meta name="personalization-v2" content="on">
    <meta name="preloads" content="/acrobat/blocks/verb-widget/icons/pdf-to-word.svg">
    ...
    <meta name="dc-widget-version" content="4.2.0_3.2.0">
    <meta name="dc-generate-cache-version" content="3.2.0">
    <meta name="ims-cid" content="acrobatmiloguest">
    <meta name="ims-guest" content="true">
<meta name="footer-source" content="https://www.adobe.com/dc-shared/navigation/footer/footer-thin" data-localized="true">
    ...
    <meta name="product-name" content="Convert PDF to Word">
    <meta name="product-description" content="Convert PDFs to Microsoft Word files in seconds using Adobe Acrobat online services. Converting PDFs to Word has never been so easy. Try converting a file today.">
    <meta name="seotech-video-url" content="https://video.tv.adobe.com/v/3435388">
    <script type="application/ld+json">{
  "@context": "https://schema.org",
  "@graph": [
    {
      "@type": "WebPage",
      "@id": "/acrobat/online/pdf-to-word/#webpage",
      "url": "/acrobat/online/pdf-to-word/",
      "publisher": {
        "@id": "https://www.adobe.com/#organization"
      },
      "mainEntity": {
        "@id": "/acrobat/online/pdf-to-word/#softwareapplication"
      }
    },
    {
      "@type": "Organization",
      ...
      "logo": {
        "@type": "ImageObject",
        "url": "content/dam/cc/icons/Adobe_Corporate_Horizontal_Red_HEX.svg",
        "contentUrl": "content/dam/cc/icons/Adobe_Corporate_Horizontal_Red_HEX.svg"
      }
    },
    {
      "name": "Convert PDF to Word",
      "description": "Convert PDFs to Microsoft Word files in seconds using Adobe Acrobat online services. Converting PDFs to Word has never been so easy. Try converting a file today.",
      "@type": "SoftwareApplication",
      "aggregateRating": {
        "@id": "/acrobat/online/pdf-to-word/#aggregaterating"
      },
      "@id": "/acrobat/online/pdf-to-word/#softwareapplication",
      "offers": [
        {
          "@id": "/acrobat/online/pdf-to-word/#offer"
        }
      ],
      "provider": {
        "@id": "https://www.adobe.com/#organization"
  ...
  window.loadLink = (href, options = {}) => {
    ...
    let link = document.head.querySelector(`link[href="/acrobat/online/$%7Bhref%7D/"]`);
    if (!link) {
...
</script><link rel="preload" as="fetch" crossorigin="anonymous" href="/acrobat/blocks/verb-widget/icons/pdf-to-word.svg"><meta name="head-loaded">
  <style id="inline-milo-styles">/*** Variables ***/
...
span.icon.milo-tooltip.margin-inline-end { margin-inline-end: 3px; }

span.icon.milo-tooltip.margin-inline-start { margin-inline-start: 3px; }
...
body:has(footer:focus-within) #onetrust-consent-sdk:not(:has(#ot-cookie-button.show)) {
  position: sticky;
  bottom: 0;
...
body:has(footer:focus-within) #onetrust-consent-sdk:not(:has(#ot-cookie-button.show)) #onetrust-banner-sdk {
  position: sticky;
}
...
body:has(.dialog-modal) #onetrust-consent-sdk {
  display: none;
}
...
header.global-navigation.new-nav.local-nav {
  top: 0;
}
...
@media screen and (max-width: 1199px) {
  /* Mweb specific changes for body typography */
  .mweb-enabled {
    --type-body-xxl-size: calc(var(--font-size-multiplier, 1) * 24px);
    --type-body-xxl-lh: 36px;
    --type-body-xl-size: calc(var(--font-size-multiplier, 1) * 20px);
    --type-body-xl-lh: 30px;
    --type-body-l-size: calc(var(--font-size-multiplier, 1) * 18px);
    --type-body-l-lh: 27px;
    --type-body-m-size: calc(var(--font-size-multiplier, 1) * 16px);
    --type-body-m-lh: 24px;
    --type-body-s-size: calc(var(--font-size-multiplier, 1) * 14px);
    --type-body-s-lh: 21px;
  }
}
...
@media screen and (min-width: 1200px) {
  ...
  /* margin */
  .con-block.margin-top-desktop { margin-top: var(--spacing-s); }
  .con-block.margin-bottom-desktop { margin-bottom: var(--spacing-s); }
}
...
</style><style id="inline-dc-styles">/*
...
:root:has(meta[name="typography"][content="studyspace"]) {
  main {
    ...
    .text-block [class*="body-"] {
      line-height: 1.5;
      font-size: 20px;
      font-weight: 400;
    }

    .hero-marquee [class*="body-"] {
      line-height: 1.5;
      font-size: 20px;
    }

    .hero-marquee [class*="heading-"] {
      line-height: 1.25;
      font-weight: 900;
      font-size: 44px;
    ...
    .quote .figcaption {
      font-family: "Adobe Clean Bold", var(--body-font-family);
      line-height: 1.5;
      font-size: 18px;
      font-weight: 700;
    }

    .quote figcaption cite p {
      font-family: "Adobe Clean Italic", var(--body-font-family);
      line-height: 1.5;
      font-size: 16px;
      font-weight: 400;
    }

    .editorial-card [class*="heading-"],
    .icon-block [class*="heading-"] {
      font-family: "Adobe Clean ExtraBold", var(--body-font-family);
      font-weight: 800;
      line-height: 1.25;
      letter-spacing: -0.03em;
...
.how-to .how-to-heading {
  word-break: break-word;
}
</style><style id="inline-verb-widget-styles">:root {
  /* Consonant Variables */
  ...
  @media screen and (min-width: 835px) {
    ...
    /* Test for Sign a PDF and H1 LCP  */
    head:has(meta[name="product-name"][content="Sign a PDF"]) + body .verb-heading {
      font-size: 55px;
    }

    head:has(meta[name="product-name"][content="Sign a PDF"]) + body .how-to-media {
      width: 200px;
...
.verb-widget.signed-in .verb-upsell-active {
  display: none;
}

.verb-widget.upsell .verb-footer {
  display: none;
}

.verb-widget.upsell #drop-zone {
  display: none;
}
...
.verb-widget .milo-tooltip::before {
...
.verb-widget .milo-tooltip::after {
  content: "";
  position: absolute;
  left: 100%;
  margin-left: -8px;
...
.verb-widget .milo-tooltip.top::after {
  left: 50%;
  top: 2px;
...
.verb-widget .milo-tooltip:hover::before,
.verb-widget .milo-tooltip:focus::before,
.verb-widget .milo-tooltip:active::before {
  display: block; 
}

.verb-widget .milo-tooltip:hover::after,
.verb-widget .milo-tooltip:focus::after,
.verb-widget .milo-tooltip:active::after {
  display: block;
}
...
@media screen and (max-width: 1199px) {
  ...
  .verb-widget .mobile.milo-tooltip.top::after {
    left: 4px;
    right: auto;
    transform: translateX(0) translateY(-50%);
  }

  .verb-widget .tablet.milo-tooltip.top::before,
  .verb-widget .milo-tooltip.top::before {
    left: auto;
    right: 0;
    transform: translateX(0) translateY(-100%);
  ...
  .verb-widget .tablet.milo-tooltip.top::after,
  .verb-widget .milo-tooltip.top::after {
    left: auto;
    right: 4px;
    transform: translateX(0) translateY(-50%);
  ...
  [dir="rtl"] .verb-widget .mobile.milo-tooltip.top::before,
  [dir="rtl"] .verb-widget .tablet.milo-tooltip.top::before {
    transform: translateX(0) translateY(-100%);
    text-align: right;
  }
  ...
  [dir="rtl"] .verb-widget .mobile.milo-tooltip.top::after,
  [dir="rtl"] .verb-widget .tablet.milo-tooltip.top::after {
    transform: translateX(0) translateY(-50%);
  }
...
</style><style>#prerender_verb-widget { position: absolute; top: 0; left: 0; width: 100%; z-index: -1; pointer-events: auto; }</style><meta property="og:locale" content="en-US"><link rel="preload" as="script" crossorigin="anonymous" href="/libs/martech/helpers.js"><link rel="preload" as="script" crossorigin="anonymous" href="/acrobat/blocks/verb-widget/verb-widget.js"><link rel="stylesheet" href="/acrobat/blocks/verb-widget/verb-widget.css"><link rel="preload" as="script" crossorigin="anonymous" href="/acrobat/blocks/unity/unity.js"><link rel="stylesheet" href="/acrobat/blocks/unity/unity.css"><link rel="stylesheet" href="/libs/blocks/global-navigation/global-navigation.css"><link rel="stylesheet" href="https://use.typekit.net/hah7vzn.css"><link rel="stylesheet" href="/libs/blocks/text/text.css"><link rel="stylesheet" href="/libs/blocks/section-metadata/section-metadata.css"><link rel="preload" as="script" href="/marketingtech/d4d114c60e50/a0e989131fd5/launch-5dd5dd2177e6.min.js"><link rel="stylesheet" href="/libs/blocks/global-navigation/base.css"><link rel="preload" as="script" crossorigin="anonymous" href="/libs/blocks/modal/modal.js"><link rel="stylesheet" href="/libs/blocks/modal/modal.css"><link rel="stylesheet" href="/libs/blocks/how-to/how-to.css"><link rel="stylesheet" href="/libs/styles/consonant-play-button.css"><script type="application/ld+json">{"@context":"http://schema.org","@type":"HowTo","name":"How to convert PDF to Word","description":"Follow these easy steps to convert your PDF files into Microsoft Word (DOCX):","publisher":{"@type":"Organization","name":"Adobe","logo":{"@type":"ImageObject","url":"content/dam/cc/icons/Adobe_Corporate_Horizontal_Red_HEX.svg"}},"step":[{"@type":"HowToStep","url":"/acrobat/online/pdf-to-word/","name":"Step 1","itemListElement":[{"@type":"HowToDirection","text":"Click the Select a file button above, or drag and drop a file into the drop zone."}]},{"@type":"HowToStep","url":"/acrobat/online/pdf-to-word/","name":"Step 2","itemListElement":[{"@type":"HowToDirection","text":"Select the PDF you want to convert to the DOCX file format."}]},{"@type":"HowToStep","url":"/acrobat/online/pdf-to-word/","name":"Step 3","itemListElement":[{"@type":"HowToDirection","text":"Watch Acrobat automatically convert the file from PDF to an editable Word document."}]},{"@type":"HowToStep","url":"/acrobat/online/pdf-to-word/","name":"Step 4","itemListElement":[{"@type":"HowToDirection","text":"Download your file. If you use the tool again, you may be asked to sign in to download it."}]}],"@image":{"@type":"ImageObject","url":"acrobat/online/media_1c20d1dfa53c47f75aefbe7bc5a58b882c5f74f55.png?width=750&format=png&optimize=medium"}}</script><link rel="stylesheet" href="/libs/blocks/icon-block/icon-block.css"><link rel="stylesheet" href="/libs/blocks/accordion/accordion.css"><script type="application/ld+json">{"@context":"https://schema.org","@type":"FAQPage","mainEntity":[[{"@type":"Question","name":"\n            \n              How do I convert a PDF to Word without losing the formatting?\n            \n          ","acceptedAnswer":{"text":"As the inventor of the PDF file format, Adobe makes sure our Acrobat PDF to Word converter preserves your document formatting. When you use our online Word to DOCX conversion tool, your fonts, images, and alignments will look as expected. The converted file is an editable Word document that you can start using right away in Microsoft Word online.","@type":"Answer"}},{"@type":"Question","name":"\n            \n              What software do I need to convert PDF to Word?\n            \n          ","acceptedAnswer":{"text":"You don’t need any other software to convert a PDF to Microsoft Word when you use the Acrobat online tool. Just open the tool in your preferred browser on any operating system, select your file, and let Acrobat complete the conversion online.","@type":"Answer"}},{"@type":"Question","name":"\n            \n              Will my converted Word document be secure?\n            \n          ","acceptedAnswer":{"text":"Yes, your converted Microsoft Word file will be secure. Adobe is known for its commitment to security and privacy, so you can convert PDF to Word, PowerPoint, or Excel with trust and confidence.","@type":"Answer"}}]]}</script><link rel="stylesheet" href="/libs/blocks/caas/caas.css"><link rel="stylesheet" href="/libs/blocks/media/media.css"><link rel="stylesheet" href="/acrobat/blocks/rnr/rnr.css"><script type="application/ld+json">{"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"Home","item":"https://www.adobe.com/"},{"@type":"ListItem","position":2,"name":"Acrobat","item":"/acrobat/"},{"@type":"ListItem","position":3,"name":"PDF to Word","item":"/acrobat/online/pdf-to-word/"}]}</script><link rel="stylesheet" href="https://prod.adobeccstatic.com/unav/1.5/UniversalNav.css"><link rel="stylesheet" type="text/css" href="https://prod.adobeccstatic.com/unav/1.5/layout.bundle.css"><link rel="stylesheet" type="text/css" href="https://prod.adobeccstatic.com/unav/1.5/popover.bundle.css"><link rel="stylesheet" type="text/css" href="https://prod.adobeccstatic.com/unav/1.5/profile.bundle.css"><script type="application/ld+json">{"name":"Convert PDF to Word","description":"Convert PDFs to Microsoft Word files in seconds using Adobe Acrobat online services. Converting PDFs to Word has never been so easy. Try converting a file today.","@type":"Product","@context":"http://schema.org","aggregateRating":{"@type":"AggregateRating","ratingValue":"4.66","ratingCount":"529623"}}</script><link rel="stylesheet" href="/libs/blocks/columns/columns.css"><link rel="stylesheet" href="/libs/blocks/global-footer/global-footer.css"><link rel="stylesheet" href="/libs/blocks/global-navigation/utilities/menu/menu.css"><script type="application/ld+json" class="seotech-video-url">{"@context":"http://schema.org","@type":"VideoObject","description":"Learn how easy it is to use our PDF to Word converter to save any PDF as a Word document.","duration":"PT0H0M37S","embedUrl":"https://video.tv.adobe.com/v/3435388/","hasPart":[{"@type":"Clip","endOffset":17,"name":"Select your file to convert","startOffset":14,"url":"https://video.tv.adobe.com/v/3435388/?t=14"},{"@type":"Clip","endOffset":25,"name":"Sign in to download","startOffset":18,"url":"https://video.tv.adobe.com/v/3435388/?t=18"},{"@type":"Clip","endOffset":37,"name":"Start fresh without starting over","startOffset":26,"url":"https://video.tv.adobe.com/v/3435388/?t=26"}],"name":"PDF to Word: How to convert a PDF to a Word doc online","thumbnailUrl":["https://images-tv.adobe.com/mpcv3/b4a190d5-5932-4107-bdfd-ea1c02da7520/7bc52ea1-a105-4f17-9e3b-1fe13264cf11/53c62e200a1e40b28e5e43588ed7ea32_1729607591-236x133.jpg","https://images-tv.adobe.com/mpcv3/b4a190d5-5932-4107-bdfd-ea1c02da7520/7bc52ea1-a105-4f17-9e3b-1fe13264cf11/53c62e200a1e40b28e5e43588ed7ea32_1729607589-220x124.jpg","https://images-tv.adobe.com/mpcv3/b4a190d5-5932-4107-bdfd-ea1c02da7520/7bc52ea1-a105-4f17-9e3b-1fe13264cf11/53c62e200a1e40b28e5e43588ed7ea32_1729607584-100x56.jpg","https://images-tv.adobe.com/mpcv3/b4a190d5-5932-4107-bdfd-ea1c02da7520/7bc52ea1-a105-4f17-9e3b-1fe13264cf11/53c62e200a1e40b28e5e43588ed7ea32_1729607596-640x360.jpg","https://images-tv.adobe.com/mpcv3/b4a190d5-5932-4107-bdfd-ea1c02da7520/7bc52ea1-a105-4f17-9e3b-1fe13264cf11/53c62e200a1e40b28e5e43588ed7ea32_1729607600-720x405.jpg","https://images-tv.adobe.com/mpcv3/b4a190d5-5932-4107-bdfd-ea1c02da7520/7bc52ea1-a105-4f17-9e3b-1fe13264cf11/53c62e200a1e40b28e5e43588ed7ea32_1729607586-150x85.jpg","https://images-tv.adobe.com/mpcv3/b4a190d5-5932-4107-bdfd-ea1c02da7520/7bc52ea1-a105-4f17-9e3b-1fe13264cf11/53c62e200a1e40b28e5e43588ed7ea32_1729607588-200x113.jpg","https://images-tv.adobe.com/mpcv3/b4a190d5-5932-4107-bdfd-ea1c02da7520/7bc52ea1-a105-4f17-9e3b-1fe13264cf11/53c62e200a1e40b28e5e43588ed7ea32_1729607595-420x236.jpg","https://images-tv.adobe.com/mpcv3/b4a190d5-5932-4107-bdfd-ea1c02da7520/7bc52ea1-a105-4f17-9e3b-1fe13264cf11/53c62e200a1e40b28e5e43588ed7ea32_1729607601-960x540.jpg","https://images-tv.adobe.com/mpcv3/b4a190d5-5932-4107-bdfd-ea1c02da7520/7bc52ea1-a105-4f17-9e3b-1fe13264cf11/53c62e200a1e40b28e5e43588ed7ea32_1729607602-1920x1080.jpg","https://images-tv.adobe.com/mpcv3/b4a190d5-5932-4107-bdfd-ea1c02da7520/7bc52ea1-a105-4f17-9e3b-1fe13264cf11/53c62e200a1e40b28e5e43588ed7ea32_1729607593-290x163.jpg","https://images-tv.adobe.com/mpcv3/b4a190d5-5932-4107-bdfd-ea1c02da7520/7bc52ea1-a105-4f17-9e3b-1fe13264cf11/53c62e200a1e40b28e5e43588ed7ea32_1729607599-666x375.jpg"],"uploadDate":"2024-10-22T14:02:10Z"}</script></head>
  <body>
      ...
      <div>
        <ul>
          ...
          <li class="feds-crossCloudMenu-item"><a href="https://helpx.adobe.com/support.html" daa-ll="Help Support-5" class="feds-navLink">Help &amp; Support</a></li>
              ...
              <a href="/acrobat/online/" class="feds-navLink" daa-ll="Tools-2">Tools</a>
            </div><div role="listitem" class="feds-navItem feds-navItem--active">
...
<path d="M6.20711 0.707106L10.5 5L0.5 5L4.79289 0.707107C5.18342 0.316583 5.81658 0.316582 6.20711 0.707106Z"></path>
      ...
      <nav class="feds-breadcrumbs" aria-label="Breadcrumb"><ul>
                ...
                <li aria-current="page"><span aria-hidden="true">/</span>PDF to Word</li>
              </ul></nav>
    </div>
              ...
              <a href="/acrobat/online/" class="feds-navLink" daa-ll="Tools-2" data-title="Tools" tabindex="-1" aria-hidden="true">Overview</a>
            </div><div role="listitem" class="feds-navItem feds-navItem--active">
    ...
    <main daa-im="true">
      ...
      <div class="section" style="background: rgb(255, 255, 255);" daa-lh="s3">
        <div class="how-to large-image seo container con-block" data-block-status="loaded" daa-lh="b1|how-to">
          
          
        <div class="foreground how-to-media-large"><div class="how-to-heading">
            
          <h2 id="how-to-convert-pdf-to-word" class="heading-l">How to convert PDF to Word</h2><p>Follow these easy steps to convert your PDF files into Microsoft Word (DOCX):</p></div><div class="how-to-media how-to-media-large"><span class="modal-img-link"><picture>
                  <source type="image/webp" srcset="/acrobat/online/media_1c20d1dfa53c47f75aefbe7bc5a58b882c5f74f55.png?width=2000&amp;format=webply&amp;optimize=medium" media="(min-width: 600px)">
                  <source type="image/webp" srcset="/acrobat/online/media_1c20d1dfa53c47f75aefbe7bc5a58b882c5f74f55.png?width=750&amp;format=webply&amp;optimize=medium">
                  <source type="image/png" srcset="/acrobat/online/media_1c20d1dfa53c47f75aefbe7bc5a58b882c5f74f55.png?width=2000&amp;format=png&amp;optimize=medium" media="(min-width: 600px)">
                  <img loading="lazy" alt="Play video: How to convert PDF to Word" src="/acrobat/online/media_1c20d1dfa53c47f75aefbe7bc5a58b882c5f74f55.png?width=750&amp;format=png&amp;optimize=medium" width="912" height="642" role="none">
                </picture><a href="/acrobat/online/pdf-to-word/" class="modal link-block image-link btn-medium consonant-play-btn" data-modal-path="/dc-shared/fragments/modals/videos/frictionless/how-to-convert-pdf-to-word" data-modal-hash="#video" role="button" aria-label="Play Play video: How to convert PDF to Word" data-block-status="loaded" daa-ll="Play Play video How -1--How to convert PDF t"><div class="play-icon-container"><svg xmlns="http://www.w3.org/2000/svg" width="40" height="42" viewBox="0 0 40 42" fill="none" class="play-icon" aria-hidden="true">
                      ...
                      </svg></div></a></span></div><ol><li><div>Click the <strong>Select a file</strong> button above, or drag and drop a file into the drop zone.</div></li><li><div>Select the PDF you want to convert to the DOCX file format.</div></li><li><div>Watch Acrobat automatically convert the file from PDF to an editable Word document.</div></li><li><div>Download your file. If you use the tool again, you may be asked to sign in to download it.</div></li></ol></div></div>
        <div class="section-metadata" data-block-status="loaded">
          <div>
            <div>style</div>
            <div></div>
      ...
      <div class="section" style="background: rgb(248, 248, 248);" daa-lh="s4">
        <div class="text xl-spacing-top large text-block con-block" data-block-status="loaded" daa-lh="b1|text">
          <div class="foreground">
            <div class="body-m">
              <h2 id="try-our-free-pdf-to-word-converter" class="heading-xl">Try our free PDF to Word converter</h2>
            </div>
          </div>
        </div>
        <div class="section-metadata" data-block-status="loaded">
      ...
      <div class="section xl-spacing three-up" style="background: rgb(248, 248, 248);" daa-lh="s5">
        <div class="section-metadata" data-block-status="loaded">
          <div>
            <div>background</div>
            <div>#f8f8f8</div>
          ...
          <div>
            <div>style</div>
            <div>xl spacing, three-up</div>
          </div>
        </div>
        <div class="icon-block vertical small xs-spacing con-block" data-block-status="loaded" daa-lh="b1|icon-block">
          <div class="foreground">
            <div class="text-content">
              <p class="icon-area"><picture><img loading="lazy" src="/dc-shared/assets/images/shared-images/frictionless/seo-icons/word-pdf-converting.svg" alt="An Acrobat PDF document and text document with arrows showing how you can convert a PDF to Microsoft Word"></picture></p>
              <h3 id="turn-pdfs-into-editable-word-files" class="heading-s">Turn PDFs into editable Word files</h3>
              <p class="body-m">Learning how to convert PDF to Word is quick and easy. Simply drag and drop your PDF, then download the converted Word file.</p>
            </div>
          </div>
        </div>
        <div class="icon-block vertical small xs-spacing con-block" data-block-status="loaded" daa-lh="b2|icon-block">
          <div class="foreground">
            <div class="text-content">
              <p class="icon-area"><picture><img loading="lazy" src="/dc-shared/assets/images/shared-images/frictionless/seo-icons/fast-pdf.svg" alt="A clock representing how fast you can convert PDF to Word"></picture></p>
              <h3 id="convert-pdf-to-docx-fast" class="heading-s">Convert PDF to DOCX fast</h3>
              <p class="body-m">Acrobat turns PDF files into the DOCX file format in seconds. When you convert PDF to DOCX with our conversion tool, your formatting will look as expected.</p>
            </div>
          </div>
        </div>
        <div class="icon-block vertical small xs-spacing con-block" data-block-status="loaded" daa-lh="b3|icon-block">
          <div class="foreground">
            <div class="text-content">
              <p class="icon-area"><picture><img loading="lazy" src="/dc-shared/assets/images/shared-images/frictionless/seo-icons/edit-word.svg" alt="A text document being edited online with a pen icon"></picture></p>
              <h3 id="edit-your-word-file-for-free" class="heading-s">Edit your Word file for free</h3>
              <p class="body-m">After you use our PDF to Word converter tool, you can edit the converted file in Microsoft Word for the web right from Acrobat. All you have to do is sign in.</p>
            </div>
          </div>
        </div>
        <div class="icon-block vertical small xs-spacing con-block" data-block-status="loaded" daa-lh="b4|icon-block">
          <div class="foreground">
            <div class="text-content">
              <p class="icon-area"><picture><img loading="lazy" src="/dc-shared/assets/images/shared-images/frictionless/seo-icons/download-and-share.svg" alt="A download arrow with a small cloud showing that you can easily download your converted file"></picture></p>
              <h3 id="download-or-share-your-file" class="heading-s">Download or share your file</h3>
              <p class="body-m">You can download your converted PDF to Word document with a click or by signing in. You can also share your new file with others when you sign in.</p>
            </div>
          </div>
        </div>
        <div class="icon-block vertical small xs-spacing con-block" data-block-status="loaded" daa-lh="b5|icon-block">
          <div class="foreground">
            <div class="text-content">
              <p class="icon-area"><picture><img loading="lazy" src="/dc-shared/assets/images/shared-images/frictionless/seo-icons/work-anywhere.svg" alt="A browser and an arrow to show that you can use Acrobat online with any web browser"></picture></p>
              <h3 id="work-online-from-anywhere" class="heading-s">Work online from anywhere</h3>
              <p class="body-m">You can convert PDF to Word and use Acrobat online tools in any web browser. It also works on Mac, Windows, IOS, Android, and Linux operating systems.</p>
            </div>
          </div>
        </div>
        <div class="icon-block vertical small xs-spacing con-block" data-block-status="loaded" daa-lh="b6|icon-block">
          <div class="foreground">
            <div class="text-content">
              <p class="icon-area"><picture><img loading="lazy" src="/dc-shared/assets/images/shared-images/frictionless/seo-icons/best-pdf.svg" alt="A PDF file ready to be converted to Word"></picture></p>
              <h3 id="use-the-best-pdf-to-word-converter" class="heading-s">Use the best PDF to Word converter</h3>
              <p class="body-m">Adobe invented the PDF file format, so you can trust the high quality of our PDF tools. Try our online PDF to Word tool to create a Word doc with confidence.</p>
            </div>
          </div>
        </div>
      </div>
      <div class="section l-spacing" style="background: rgb(255, 255, 255);" daa-lh="s6">
        <div class="text large s-spacing-top text-block con-block" data-block-status="loaded" daa-lh="b1|text">
          <div class="foreground">
            <div class="body-m">
              <h2 id="questions-about-the-pdf-to-word-converter-we-have-answers" class="heading-xl">Questions about the PDF to Word converter? We have answers.</h2>
            </div>
          </div>
        </div>
        <div class="accordion-container seo con-block max-width-10-desktop" data-block-status="loaded" daa-lh="b2|accordion-conta"><div class="descr-list accordion foreground" id="accordion-1" role="presentation"><div class="descr-term"><h3 class="accordion-heading"><button type="button" id="accordion-1-trigger-1" class="accordion-trigger tracking-header" aria-expanded="false" aria-controls="accordion-1-content-1" daa-ll="open-1--How do I convert a P">
            
              How do I convert a PDF to Word without losing the formatting?
            
          <span class="accordion-icon"></span></button></h3></div><div aria-labelledby="accordion-1-trigger-1" id="accordion-1-content-1" hidden="true" class="descr-details"><div>
              <p>As the inventor of the PDF file format, Adobe makes sure our Acrobat PDF to Word converter preserves your document formatting. When you use our online Word to DOCX conversion tool, your fonts, images, and alignments will look as expected. The converted file is an editable Word document that you can start using right away in Microsoft Word online.</p>
              <p>You can also start an <a href="/acrobat/free-trial-download/" daa-ll="Adobe Acrobat Pro-2--How do I convert a P">Adobe Acrobat Pro</a> 7-day free trial to convert files to and from Microsoft 365, edit PDF documents with PDF editor tools, edit scanned documents using optical character recognition (OCR) functionality, <a href="/acrobat/online/merge-pdf/" daa-ll="merge PDFs-3--How do I convert a P">merge PDFs</a>, organize or rotate PDF pages, split PDFs, <a href="/acrobat/online/compress-pdf/" daa-ll="reduce file size-4--How do I convert a P">reduce file size</a>, and convert HTML, TXT, RTF, PNG, JPG, BMP, and other formats to PDF.</p>
            </div></div><div class="descr-term"><h3 class="accordion-heading"><button type="button" id="accordion-1-trigger-2" class="accordion-trigger tracking-header" aria-expanded="false" aria-controls="accordion-1-content-2" daa-ll="open-2--What software do I n">
            
              What software do I need to convert PDF to Word?
            
          <span class="accordion-icon"></span></button></h3></div><div aria-labelledby="accordion-1-trigger-2" id="accordion-1-content-2" hidden="true" class="descr-details"><div>You don’t need any other software to convert a PDF to Microsoft Word when you use the Acrobat online tool. Just open the tool in your preferred browser on any operating system, select your file, and let Acrobat complete the conversion online.</div></div><div class="descr-term"><h3 class="accordion-heading"><button type="button" id="accordion-1-trigger-3" class="accordion-trigger tracking-header" aria-expanded="false" aria-controls="accordion-1-content-3" daa-ll="open-3--Will my converted Wo">
            
              Will my converted Word document be secure?
            
          <span class="accordion-icon"></span></button></h3></div><div aria-labelledby="accordion-1-trigger-3" id="accordion-1-content-3" hidden="true" class="descr-details"><div>Yes, your converted Microsoft Word file will be secure. Adobe is known for its commitment to security and privacy, so you can convert PDF to Word, PowerPoint, or Excel with trust and confidence.</div></div></div></div>
        <div class="section-metadata" data-block-status="loaded">
          <div>
            <div>style</div>
            <div>l spacing</div>
      ...
      <div class="section xl-spacing" style="background: rgb(248, 248, 248);" daa-lh="s7">
        <div class="text large s-spacing contained text-block con-block" data-block-status="loaded" daa-lh="b1|text">
          <div class="foreground">
            <div class="body-m">
              <h2 id="more-resources-to-convert-pdf-to-word" class="heading-xl">More resources to convert PDF to Word</h2>
            </div>
          </div>
        </div><div class="content"><p><a href="https://milo.adobe.com/tools/caas#~~" class="caas link-block" data-block-status="loaded" daa-lh="b2|caas">Content as a Service v3 - pdf-to-word - Thursday, February 20, 2025 at 17:28</a></p></div>
      ...
      <div class="section s-spacing" style="background: rgb(255, 255, 255);" daa-lh="s8">
        <div class="media large con-block" data-block-status="loaded" daa-lh="b1|media">
          
        <div class="container foreground"><div class="media-row">
            <div class="image"><picture><img loading="lazy" src="/dc-shared/assets/images/shared-images/frictionless/create-an-account-image/create-an-account.svg" alt="a text bubble, pencil icon, and a stacked PDF icon representing free online Acrobat tools"></picture></div>
            <div class="text">
              <h2 id="use-acrobat-tools-for-free" class="heading-xl">Use Acrobat tools for free</h2>
              <ul class="body-m">
                <li>Sign in to try 25+ tools, like convert or compress</li>
                <li>Add comments, fill in forms, and sign PDFs for free</li>
                <li>Store your files online to access from any device</li>
              </ul>
              <div class="cta-container"><p class="body-m action-area"><a href="https://auth.services.adobe.com/en_US/index.html?callback=https%3A%2F%2Fims-na1.adobelogin.com%2Fims%2Fadobeid%2FDocumentCloud1%2FAdobeID%2Ftoken%3Fredirect_uri%3Dhttps%253A%252F%252Fcloud.acrobat.com%26state%3D%257B%2522ac%2522%253A%2522%2522%252C%2522jslibver%2522%253A%2522v2-v0.32.0-1-gea1608c%2522%252C%2522nonce%2522%253A%25221039632031482160%2522%257D%26code_challenge_method%3Dplain%26use_ms_for_expiry%3Dtrue&amp;client_id=DocumentCloud1&amp;scope=AdobeID%2Copenid%2Ccreative_cloud%2Cgnav%2Csao.cce_private%2Cadditional_info.roles%2Cread_organizations&amp;denied_callback=https%3A%2F%2Fims-na1.adobelogin.com%2Fims%2Fdenied%2FDocumentCloud1%3Fredirect_uri%3Dhttps%253A%252F%252Fcloud.acrobat.com%26response_type%3Dtoken%26state%3D%257B%2522ac%2522%253A%2522%2522%252C%2522jslibver%2522%253A%2522v2-v0.32.0-1-gea1608c%2522%252C%2522nonce%2522%253A%25221039632031482160%2522%257D&amp;state=%7B%22ac%22%3A%22%22%2C%22jslibver%22%3A%22v2-v0.32.0-1-gea1608c%22%2C%22nonce%22%3A%221039632031482160%22%7D&amp;relay=47a4e100-4959-462e-ac0a-eb5afd82561e&amp;locale=en_US&amp;flow_type=token&amp;dctx_id=v:2,s,ed540b00-776e-11ee-ba8e-ddb372e95c97&amp;s_p=apple%2Cfacebook%2Cgoogle#/signup" aria-label="Create a free account Adobe Acrobat" class="con-button blue" daa-ll="Create a free accoun-1--Use Acrobat tools fo">Create a free account</a> <a href="https://auth.services.adobe.com/en_US/index.html?callback=https%3A%2F%2Fims-na1.adobelogin.com%2Fims%2Fadobeid%2FDocumentCloud1%2FAdobeID%2Ftoken%3Fredirect_uri%3Dhttps%253A%252F%252Fcloud.acrobat.com%26state%3D%257B%2522ac%2522%253A%2522%2522%252C%2522jslibver%2522%253A%2522v2-v0.32.0-1-gea1608c%2522%252C%2522nonce%2522%253A%25221039632031482160%2522%257D%26code_challenge_method%3Dplain%26use_ms_for_expiry%3Dtrue&amp;client_id=DocumentCloud1&amp;scope=AdobeID%2Copenid%2Ccreative_cloud%2Cgnav%2Csao.cce_private%2Cadditional_info.roles%2Cread_organizations&amp;denied_callback=https%3A%2F%2Fims-na1.adobelogin.com%2Fims%2Fdenied%2FDocumentCloud1%3Fredirect_uri%3Dhttps%253A%252F%252Fcloud.acrobat.com%26response_type%3Dtoken%26state%3D%257B%2522ac%2522%253A%2522%2522%252C%2522jslibver%2522%253A%2522v2-v0.32.0-1-gea1608c%2522%252C%2522nonce%2522%253A%25221039632031482160%2522%257D&amp;state=%7B%22ac%22%3A%22%22%2C%22jslibver%22%3A%22v2-v0.32.0-1-gea1608c%22%2C%22nonce%22%3A%221039632031482160%22%7D&amp;relay=47a4e100-4959-462e-ac0a-eb5afd82561e&amp;locale=en_US&amp;flow_type=token&amp;dctx_id=v:2,s,ed540b00-776e-11ee-ba8e-ddb372e95c97&amp;idp_flow_type=login&amp;s_p=apple%2Cfacebook%2Cgoogle#/" daa-ll="Sign in-2--Use Acrobat tools fo">Sign in</a></p></div>
            </div>
          </div></div></div>
        <div class="section-metadata" data-block-status="loaded">
          <div>
      ...
      <div class="section center xxl-spacing divider" style="background: rgb(248, 248, 248);" daa-lh="s9">
        <div class="rnr" data-block-status="loaded" daa-lh="b1|rnr">
          
        <div class="rnr-container"><h3 class="rnr-title">Rate your experience</h3><form class="rnr-form"><fieldset class="rnr-rating-fieldset"><legend>Rate your experience</legend><input data-tooltip="Poor" name="rating" aria-label="Poor 1 star" type="radio" class="tooltip" aria-checked="false" value="1"><input data-tooltip="Below Average" name="rating" aria-label="Below Average 2 stars" type="radio" class="tooltip" aria-checked="false" value="2"><input data-tooltip="Good" name="rating" aria-label="Good 3 stars" type="radio" class="tooltip" aria-checked="false" value="3"><input data-tooltip="Very Good" name="rating" aria-label="Very Good 4 stars" type="radio" class="tooltip" aria-checked="false" value="4"><input data-tooltip="Outstanding" name="rating" aria-label="Outstanding 5 stars" type="radio" class="tooltip" aria-checked="false" value="5"></fieldset></form><div class="rnr-summary-container "><span class="rnr-summary-average">4.7</span><span>/</span><span class="rnr-summary-outOf">5</span><span>-</span><span class="rnr-summary-votes">529623</span><span>votes</span></div></div></div>
        <div class="section-metadata" data-block-status="loaded">
          <div>
            <div>style</div>
            <div>Center, Xxl-spacing, divider</div>
          </div>
          <div>
            <div>background</div>
            <div>#f8f8f8</div>
      ...
      <div class="section center" style="background: rgb(251, 251, 251);" daa-lh="s10">
        <div class="text center large xs-spacing-bottom xl-spacing-top text-block con-block" data-block-status="loaded" daa-lh="b1|text">
          <div class="foreground">
            <div class="body-m">
              <h2 id="try-these-acrobat-online-tools" class="heading-xl">Try these Acrobat online tools</h2>
            </div>
          </div>
        </div>
        <div class="columns verb-subfooter container" data-block-status="loaded" daa-lh="b2|columns">
          <div class="row row-1">
            <div class="col col-1">
              <h3 id="convert-from-pdf">Convert from PDF</h3>
              <ul>
                <li><picture><img loading="lazy" src="/dc-shared/assets/images/frictionless/verb-footer-images/pdf-to-word.svg" alt=""></picture> <a href="/acrobat/online/pdf-to-word/" daa-ll="PDF to Word-1--Convert from PDF">PDF to Word</a></li>
                <li><picture><img loading="lazy" src="/dc-shared/assets/images/frictionless/verb-footer-images/pdf-to-jpg.svg" alt=""></picture> <a href="/acrobat/online/pdf-to-jpg/" daa-ll="PDF to JPG-2--Convert from PDF">PDF to JPG</a></li>
                <li><picture><img loading="lazy" src="/dc-shared/assets/images/frictionless/verb-footer-images/pdf-to-png.svg" alt=""></picture> <a href="/acrobat/online/pdf-to-png/" daa-ll="PDF to PNG-3--Convert from PDF">PDF to PNG</a></li>
                <li><picture><img loading="lazy" src="/dc-shared/assets/images/frictionless/verb-footer-images/pdf-to-excel.svg" alt=""></picture> <a href="/acrobat/online/pdf-to-excel/" daa-ll="PDF to Excel-4--Convert from PDF">PDF to Excel</a></li>
                <li><picture><img loading="lazy" src="/dc-shared/assets/images/frictionless/verb-footer-images/pdf-to-ppt.svg" alt=""></picture> <a href="/acrobat/online/pdf-to-ppt/" daa-ll="PDF to PPT-5--Convert from PDF">PDF to PPT</a></li>
                <li><picture><img loading="lazy" src="/dc-shared/assets/images/frictionless/verb-footer-images/convert-pdf.svg" alt=""></picture> <a href="/acrobat/online/convert-pdf/" daa-ll="PDF converter-6--Convert from PDF">PDF converter</a></li>
              </ul>
            </div>
            <div class="col col-2">
              <h3 id="convert-to-pdf">Convert to PDF</h3>
              <ul>
                <li><picture><img loading="lazy" src="/dc-shared/assets/images/frictionless/verb-footer-images/word-to-pdf.svg" alt=""></picture> <a href="/acrobat/online/word-to-pdf/" daa-ll="Word to PDF-7--Convert to PDF">Word to PDF</a></li>
                <li><picture><img loading="lazy" src="/dc-shared/assets/images/frictionless/verb-footer-images/jpg-to-pdf.svg" alt=""></picture> <a href="/acrobat/online/jpg-to-pdf/" daa-ll="JPG to PDF-8--Convert to PDF">JPG to PDF</a></li>
                <li><picture><img loading="lazy" src="/dc-shared/assets/images/frictionless/verb-footer-images/png-to-pdf.svg" alt=""></picture> <a href="/acrobat/online/png-to-pdf/" daa-ll="PNG to PDF-9--Convert to PDF">PNG to PDF</a></li>
                <li><picture><img loading="lazy" src="/dc-shared/assets/images/product-icons/frictionless-svg/heic-to-pdf.svg" alt=""></picture> <a href="https://acrobat.adobe.com/heic-to-pdf" data-has-dnt="true" daa-ll="HEIC to PDF-10--Convert to PDF">HEIC to PDF</a></li>
                <li><picture><img loading="lazy" src="/dc-shared/assets/images/frictionless/verb-footer-images/excel-to-pdf.svg" alt=""></picture> <a href="/acrobat/online/excel-to-pdf/" daa-ll="Excel to PDF-11--Convert to PDF">Excel to PDF</a></li>
                <li><picture><img loading="lazy" src="/dc-shared/assets/images/frictionless/verb-footer-images/ppt-to-pdf.svg" alt=""></picture> <a href="/acrobat/online/ppt-to-pdf/" daa-ll="PPT to PDF-12--Convert to PDF">PPT to PDF</a></li>
                <li><picture><img loading="lazy" src="/dc-shared/assets/images/frictionless/verb-footer-images/ocr-pdf.svg" alt=""></picture> <a href="/acrobat/online/ocr-pdf/" daa-ll="OCR PDF-13--Convert to PDF">OCR PDF</a></li>
              </ul>
              <h3 id="reduce-file-size">Reduce file size</h3>
              <ul>
                <li><picture><img loading="lazy" src="/dc-shared/assets/images/frictionless/verb-footer-images/compress-pdf.svg" alt=""></picture> <a href="/acrobat/online/compress-pdf/" daa-ll="Compress PDF-14--Reduce file size">Compress PDF</a></li>
              </ul>
            </div>
            <div class="col col-3">
              <h3 id="edit">Edit</h3>
              <ul>
                <li><picture><img loading="lazy" src="/dc-shared/assets/images/frictionless/verb-footer-images/pdf-editor.svg" alt=""></picture> <a href="/acrobat/online/pdf-editor/" daa-ll="Edit PDF-15--Edit">Edit PDF</a></li>
                <li><picture><img loading="lazy" src="/dc-shared/assets/images/frictionless/verb-footer-images/merge-pdf.svg" alt=""></picture> <a href="/acrobat/online/merge-pdf/" daa-ll="Merge PDFs-16--Edit">Merge PDFs</a></li>
                <li><picture><img loading="lazy" src="/dc-shared/assets/images/frictionless/verb-footer-images/split-pdf.svg" alt=""></picture> <a href="/acrobat/online/split-pdf/" daa-ll="Split PDF-17--Edit">Split PDF</a></li>
                <li><picture><img loading="lazy" src="/dc-shared/assets/images/frictionless/verb-footer-images/crop-pdf.svg" alt=""></picture> <a href="/acrobat/online/crop-pdf/" daa-ll="Crop PDF-18--Edit">Crop PDF</a></li>
                <li><picture><img loading="lazy" src="/dc-shared/assets/images/frictionless/verb-footer-images/delete-pdf-pages.svg" alt=""></picture> <a href="/acrobat/online/delete-pdf-pages/" daa-ll="Delete PDF pages-19--Edit">Delete PDF pages</a></li>
                <li><picture><img loading="lazy" src="/dc-shared/assets/images/frictionless/verb-footer-images/rotate-pages.svg" alt=""></picture> <a href="/acrobat/online/rotate-pdf/" daa-ll="Rotate PDF pages-20--Edit">Rotate PDF pages</a></li>
                <li><picture><img loading="lazy" src="/dc-shared/assets/images/frictionless/verb-footer-images/rearrange-pdf.svg" alt=""></picture> <a href="/acrobat/online/rearrange-pdf/" daa-ll="Reorder PDF pages-21--Edit">Reorder PDF pages</a></li>
                <li><picture><img loading="lazy" src="/dc-shared/assets/images/frictionless/verb-footer-images/extract-pdf-pages.svg" alt=""></picture> <a href="/acrobat/online/extract-pdf-pages/" daa-ll="Extract PDF pages-22--Edit">Extract PDF pages</a></li>
                <li><picture><img loading="lazy" src="/dc-shared/assets/images/frictionless/verb-footer-images/add-pages-to-pdf.svg" alt=""></picture> <a href="/acrobat/online/add-pages-to-pdf/" daa-ll="Insert PDF pages-23--Edit">Insert PDF pages</a></li>
                <li><picture><img loading="lazy" src="/dc-shared/assets/images/frictionless/verb-footer-images/add-pdf-page-numbers.svg" alt=""></picture> <a href="/acrobat/online/add-pdf-page-numbers/" daa-ll="Number PDF pages-24--Edit">Number PDF pages</a></li>
              </ul>
            </div>
            <div class="col col-4">
              <h3 id="sign--protect">Sign &amp; Protect</h3>
              <ul>
                <li><picture><img loading="lazy" src="/dc-shared/assets/images/frictionless/verb-footer-images/sign-pdf.svg" alt=""></picture> <a href="/acrobat/online/sign-pdf/" daa-ll="Fill Sign-25--Sign Protect">Fill &amp; Sign</a></li>
                <li><picture><img loading="lazy" src="/dc-shared/assets/images/frictionless/verb-footer-images/request-signatures.svg" alt=""></picture> <a href="/acrobat/online/request-signature/" daa-ll="Request e signatures-26--Sign Protect">Request e-signatures</a></li>
                <li><picture><img loading="lazy" src="/dc-shared/assets/images/frictionless/verb-footer-images/password-protect-pdf.svg" alt=""></picture> <a href="/acrobat/online/password-protect-pdf/" daa-ll="Protect PDF-27--Sign Protect">Protect PDF</a></li>
              </ul>
              <h3 id="generative-ai">Generative AI</h3>
              <ul>
                <li><picture><img loading="lazy" src="/dc-shared/assets/images/frictionless/verb-footer-images/aichat.svg" alt=""></picture> <a href="/acrobat/online/ai-chat-pdf/" daa-ll="Chat with PDF-28--Generative AI">Chat with PDF</a></li>
                <li><picture><img loading="lazy" src="/dc-shared/assets/images/frictionless/verb-footer-images/summary-generator.svg" alt=""></picture> <a href="/acrobat/online/ai-summary-generator/" daa-ll="Summary Generator-29--Generative AI">Summary Generator</a></li>
                <li><picture><img loading="lazy" src="/dc-shared/assets/images/frictionless/verb-footer-images/pdf-ai.svg" alt=""></picture> <a href="/acrobat/online/pdf-ai/" daa-ll="PDF AI-30--Generative AI">PDF AI</a></li>
                <li><picture><img loading="lazy" src="/dc-shared/assets/images/frictionless/verb-footer-images/generate-presentation.svg" alt=""></picture> <a href="/express/create/ai/presentation/" daa-ll="Generate Presentatio-31--Generative AI"><u>Generate Presentation</u></a></li>
              </ul>
            </div>
          </div>
        </div>
      ...
      <div class="section center" style="background: rgb(251, 251, 251);" daa-lh="s11">
        <div class="accordion-container verb-subfooter-moblie con-block max-width-10-desktop" data-block-status="loaded" daa-lh="b1|accordion-conta"><div class="descr-list accordion foreground" id="accordion-2" role="presentation"><div role="heading" aria-level="3" class="descr-term"><button type="button" id="accordion-2-trigger-1" class="accordion-trigger tracking-header" aria-expanded="false" aria-controls="accordion-2-content-1" daa-ll="open-1--Convert from PDF">
            Convert from PDF
          <span class="accordion-icon"></span></button></div><div aria-labelledby="accordion-2-trigger-1" id="accordion-2-content-1" hidden="true" class="descr-details"><div>
              <ul>
                <li><picture><img loading="lazy" src="/dc-shared/assets/images/frictionless/verb-footer-images/pdf-to-word.svg" alt=""></picture> <a href="/acrobat/online/pdf-to-word/" daa-ll="PDF to Word-2--Convert from PDF">PDF to Word</a></li>
                <li><picture><img loading="lazy" src="/dc-shared/assets/images/frictionless/verb-footer-images/pdf-to-jpg.svg" alt=""></picture> <a href="/acrobat/online/pdf-to-jpg/" daa-ll="PDF to JPG-3--Convert from PDF">PDF to JPG</a></li>
                <li><picture><img loading="lazy" src="/dc-shared/assets/images/frictionless/verb-footer-images/pdf-to-png.svg" alt=""></picture> <a href="/acrobat/online/pdf-to-png/" daa-ll="PDF to PNG-4--Convert from PDF">PDF to PNG</a></li>
                <li><picture><img loading="lazy" src="/dc-shared/assets/images/frictionless/verb-footer-images/pdf-to-excel.svg" alt=""></picture> <a href="/acrobat/online/pdf-to-excel/" daa-ll="PDF to Excel-5--Convert from PDF">PDF to Excel</a></li>
                <li><picture><img loading="lazy" src="/dc-shared/assets/images/frictionless/verb-footer-images/pdf-to-ppt.svg" alt=""></picture> <a href="/acrobat/online/pdf-to-ppt/" daa-ll="PDF to PPT-6--Convert from PDF">PDF to PPT</a></li>
                <li><picture><img loading="lazy" src="/dc-shared/assets/images/frictionless/verb-footer-images/convert-pdf.svg" alt=""></picture> <a href="/acrobat/online/convert-pdf/" daa-ll="PDF converter-7--Convert from PDF">PDF converter</a></li>
              </ul>
            </div></div><div role="heading" aria-level="3" class="descr-term"><button type="button" id="accordion-2-trigger-2" class="accordion-trigger tracking-header" aria-expanded="false" aria-controls="accordion-2-content-2" daa-ll="open-2--Convert to PDF">
            Convert to PDF
          <span class="accordion-icon"></span></button></div><div aria-labelledby="accordion-2-trigger-2" id="accordion-2-content-2" hidden="true" class="descr-details"><div>
              <ul>
                <li><picture><img loading="lazy" src="/dc-shared/assets/images/frictionless/verb-footer-images/word-to-pdf.svg" alt=""></picture> <a href="/acrobat/online/word-to-pdf/" daa-ll="Word to PDF-9--Convert to PDF">Word to PDF</a></li>
                <li><picture><img loading="lazy" src="/dc-shared/assets/images/frictionless/verb-footer-images/jpg-to-pdf.svg" alt=""></picture> <a href="/acrobat/online/jpg-to-pdf/" daa-ll="JPG to PDF-10--Convert to PDF">JPG to PDF</a></li>
                <li><picture><img loading="lazy" src="/dc-shared/assets/images/frictionless/verb-footer-images/png-to-pdf.svg" alt=""></picture> <a href="/acrobat/online/png-to-pdf/" daa-ll="PNG to PDF-11--Convert to PDF">PNG to PDF</a></li>
                <li><picture><img loading="lazy" src="/dc-shared/assets/images/product-icons/frictionless-svg/heic-to-pdf.svg" alt=""></picture> <a href="https://acrobat.adobe.com/heic-to-pdf" data-has-dnt="true" daa-ll="HEIC to PDF-12--Convert to PDF">HEIC to PDF</a></li>
                <li><picture><img loading="lazy" src="/dc-shared/assets/images/frictionless/verb-footer-images/excel-to-pdf.svg" alt=""></picture> <a href="/acrobat/online/excel-to-pdf/" daa-ll="Excel to PDF-13--Convert to PDF">Excel to PDF</a></li>
                <li><picture><img loading="lazy" src="/dc-shared/assets/images/frictionless/verb-footer-images/ppt-to-pdf.svg" alt=""></picture> <a href="/acrobat/online/ppt-to-pdf/" daa-ll="PPT to PDF-14--Convert to PDF">PPT to PDF</a></li>
                <li><picture><img loading="lazy" src="/dc-shared/assets/images/frictionless/verb-footer-images/ocr-pdf.svg" alt=""></picture> <a href="/acrobat/online/ocr-pdf/" daa-ll="OCR PDF-15--Convert to PDF">OCR PDF</a></li>
              </ul>
            </div></div><div role="heading" aria-level="3" class="descr-term"><button type="button" id="accordion-2-trigger-3" class="accordion-trigger tracking-header" aria-expanded="false" aria-controls="accordion-2-content-3" daa-ll="open-3--Reduce file size">
            Reduce file size
          <span class="accordion-icon"></span></button></div><div aria-labelledby="accordion-2-trigger-3" id="accordion-2-content-3" hidden="true" class="descr-details"><div>
              <ul>
                <li><picture><img loading="lazy" src="/dc-shared/assets/images/frictionless/verb-footer-images/compress-pdf.svg" alt=""></picture> <a href="/acrobat/online/compress-pdf/" daa-ll="Compress PDF-17--Reduce file size">Compress PDF</a></li>
              </ul>
            </div></div><div role="heading" aria-level="3" class="descr-term"><button type="button" id="accordion-2-trigger-4" class="accordion-trigger tracking-header" aria-expanded="false" aria-controls="accordion-2-content-4" daa-ll="open-4--Edit">
            Edit
          <span class="accordion-icon"></span></button></div><div aria-labelledby="accordion-2-trigger-4" id="accordion-2-content-4" hidden="true" class="descr-details"><div>
              <ul>
                <li><picture><img loading="lazy" src="/dc-shared/assets/images/frictionless/verb-footer-images/pdf-editor.svg" alt=""></picture> <a href="/acrobat/online/pdf-editor/" daa-ll="Edit PDF-19--Edit">Edit PDF</a></li>
                <li><picture><img loading="lazy" src="/dc-shared/assets/images/frictionless/verb-footer-images/merge-pdf.svg" alt=""></picture> <a href="/acrobat/online/merge-pdf/" daa-ll="Merge PDFs-20--Edit">Merge PDFs</a></li>
                <li><picture><img loading="lazy" src="/dc-shared/assets/images/frictionless/verb-footer-images/split-pdf.svg" alt=""></picture> <a href="/acrobat/online/split-pdf/" daa-ll="Split PDF-21--Edit">Split PDF</a></li>
                <li><picture><img loading="lazy" src="/dc-shared/assets/images/frictionless/verb-footer-images/crop-pdf.svg" alt=""></picture> <a href="/acrobat/online/crop-pdf/" daa-ll="Crop PDF-22--Edit">Crop PDF</a></li>
                <li><picture><img loading="lazy" src="/dc-shared/assets/images/frictionless/verb-footer-images/delete-pdf-pages.svg" alt=""></picture> <a href="/acrobat/online/delete-pdf-pages/" daa-ll="Delete PDF pages-23--Edit">Delete PDF pages</a></li>
                <li><picture><img loading="lazy" src="/dc-shared/assets/images/frictionless/verb-footer-images/rotate-pages.svg" alt=""></picture> <a href="/acrobat/online/rotate-pdf/" daa-ll="Rotate PDF pages-24--Edit">Rotate PDF pages</a></li>
                <li><picture><img loading="lazy" src="/dc-shared/assets/images/frictionless/verb-footer-images/rearrange-pdf.svg" alt=""></picture> <a href="/acrobat/online/rearrange-pdf/" daa-ll="Reorder PDF pages-25--Edit">Reorder PDF pages</a></li>
                <li><picture><img loading="lazy" src="/dc-shared/assets/images/frictionless/verb-footer-images/extract-pdf-pages.svg" alt=""></picture> <a href="/acrobat/online/extract-pdf-pages/" daa-ll="Extract PDF pages-26--Edit">Extract PDF pages</a></li>
                <li><picture><img loading="lazy" src="/dc-shared/assets/images/frictionless/verb-footer-images/add-pages-to-pdf.svg" alt=""></picture> <a href="/acrobat/online/add-pages-to-pdf/" daa-ll="Insert PDF pages-27--Edit">Insert PDF pages</a></li>
                <li><picture><img loading="lazy" src="/dc-shared/assets/images/frictionless/verb-footer-images/add-pdf-page-numbers.svg" alt=""></picture> <a href="/acrobat/online/add-pdf-page-numbers/" daa-ll="Number PDF pages-28--Edit">Number PDF pages</a></li>
              </ul>
            </div></div><div role="heading" aria-level="3" class="descr-term"><button type="button" id="accordion-2-trigger-5" class="accordion-trigger tracking-header" aria-expanded="false" aria-controls="accordion-2-content-5" daa-ll="open-5--Sign Protect">
            Sign &amp; Protect
          <span class="accordion-icon"></span></button></div><div aria-labelledby="accordion-2-trigger-5" id="accordion-2-content-5" hidden="true" class="descr-details"><div>
              <ul>
                <li><picture><img loading="lazy" src="/dc-shared/assets/images/frictionless/verb-footer-images/sign-pdf.svg" alt=""></picture> <a href="/acrobat/online/sign-pdf/" daa-ll="Fill Sign-30--Sign Protect">Fill &amp; Sign</a></li>
                <li><picture><img loading="lazy" src="/dc-shared/assets/images/frictionless/verb-footer-images/request-signatures.svg" alt=""></picture> <a href="/acrobat/online/request-signature/" daa-ll="Request e signatures-31--Sign Protect">Request e-signatures</a></li>
                <li><picture><img loading="lazy" src="/dc-shared/assets/images/frictionless/verb-footer-images/password-protect-pdf.svg" alt=""></picture> <a href="/acrobat/online/password-protect-pdf/" daa-ll="Protect PDF-32--Sign Protect">Protect PDF</a></li>
              </ul>
            </div></div><div role="heading" aria-level="3" class="descr-term"><button type="button" id="accordion-2-trigger-6" class="accordion-trigger tracking-header" aria-expanded="false" aria-controls="accordion-2-content-6" daa-ll="open-6--Generative AI">
            Generative AI
          <span class="accordion-icon"></span></button></div><div aria-labelledby="accordion-2-trigger-6" id="accordion-2-content-6" hidden="true" class="descr-details"><div>
              <ul>
                <li><picture><img loading="lazy" src="/dc-shared/assets/images/frictionless/verb-footer-images/aichat.svg" alt=""></picture> <a href="/acrobat/online/ai-chat-pdf/" daa-ll="Chat with PDF-34--Generative AI"><u>Chat with PDF</u></a></li>
                <li><picture><img loading="lazy" src="/dc-shared/assets/images/frictionless/verb-footer-images/summary-generator.svg" alt=""></picture> <a href="/acrobat/online/ai-summary-generator/" daa-ll="Summary Generator-35--Generative AI">Summary Generator</a></li>
                <li><picture><img loading="lazy" src="/dc-shared/assets/images/frictionless/verb-footer-images/pdf-ai.svg" alt=""></picture> <a href="/acrobat/online/pdf-ai/" daa-ll="PDF AI-36--Generative AI">PDF AI</a></li>
                <li><picture><img loading="lazy" src="/dc-shared/assets/images/frictionless/verb-footer-images/generate-presentation.svg" alt=""></picture> <a href="/express/create/ai/presentation/" daa-ll="Generate Presentatio-37--Generative AI"><u>Generate Presentation</u></a></li>
              </ul>
            </div></div></div></div>
        <div class="section-metadata" data-block-status="loaded">
          <div>
      ...
      <div class="section center" style="background: rgb(251, 251, 251);" daa-lh="s12">
        <div class="section-metadata" data-block-status="loaded">
          <div>
            <div>style</div>
            <div>Center</div>
...
async function loadPage() {
  ...
  if (widgetBlock && !hasMobileAppBlock) {
    ...
    const dcUrls = INLINE_SNIPPET ? [] : [
      `/dc/dc-generate-cache/dc-hosted-${DC_GENERATE_CACHE_VERSION}/${verb}-${ietf.toLowerCase()}/`,
    ];
  ...
  (async () => {
    if (document.querySelector('meta[name="dc-widget-version"]') && !hasMobileAppBlock) {
      const { default: ContentSecurityPolicy } = {default:()=>{}};
  ...
  if (getMetadata('commerce')) {
    const { default: replacePlaceholdersWithImages } = await import('acrobat/scripts/imageReplacer.js');
  ...
  window.addEventListener('IMS:Ready', async () => {
    ...
    if (susiElems.length > 0) {
      const { default: handleImsSusi } = await import('acrobat/scripts/susiAuthHandler.js');
  ...
  // Setup Logging
  const { default: lanaLogging } = await import('/acrobat/scripts/dcLana.js');
  lanaLogging();
  ...
  if (document.querySelectorAll('a[class*="geo-pn"]').length > 0 || document.querySelectorAll('a[href*="geo"]').length > 0) {
    const { default: geoPhoneNumber } = await import('acrobat/scripts/geo-phoneNumber.js');
    geoPhoneNumber();
  }

  // Import tooltip accessibility implementation for WCAG 1.4.13 and 4.1.2
  if (document.querySelectorAll('.milo-tooltip').length > 0) {
    const { default: initTooltips } = await import('acrobat/scripts/tooltips.js');
    initTooltips();
  }
}
